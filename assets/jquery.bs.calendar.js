(function ($) {
	...
	Date.prototype.showDayFormatted = function () {
		let options = { weekday: 'long' };
		return this.toLocaleDateString(Date.DEFAULT_LOCALE, options);
	}	

	Date.prototype.showDateFormatted2 = function () {
		let month = this.toLocaleDateString(Date.DEFAULT_LOCALE, { month: '2-digit' });
		let date = this.toLocaleDateString(Date.DEFAULT_LOCALE, { day: '2-digit' });
		let year = this.toLocaleDateString(Date.DEFAULT_LOCALE, { year: 'numeric' });
	...
	function drawTemplate(container) {
		...
		container
            ...
            <div class="d-flex flex-nowrap justify-content-between align-items-center my-2">
                <a href="#" class="text-dark btn-prev-month"><svg data-v-12e91ab4="" data-v-2083cb72="" width="26px" height="26px" viewBox="3 2 12 32" class="svg-icon c-arrow c-disabled"><path data-v-12e91ab4="" d="M11.196 10c0 0.143-0.071 0.304-0.179 0.411l-7.018 7.018 7.018 7.018c0.107 0.107 0.179 0.268 0.179 0.411s-0.071 0.304-0.179 0.411l-0.893 0.893c-0.107 0.107-0.268 0.179-0.411 0.179s-0.304-0.071-0.411-0.179l-8.321-8.321c-0.107-0.107-0.179-0.268-0.179-0.411s0.071-0.304 0.179-0.411l8.321-8.321c0.107-0.107 0.268-0.179 0.411-0.179s0.304 0.071 0.411 0.179l0.893 0.893c0.107 0.107 0.179 0.25 0.179 0.411z"></path></svg></a>
                <a href="#!" class="text-dark month-name"></a>
                <a href="#" class="text-dark btn-next-month"><svg data-v-12e91ab4="" data-v-2083cb72="" width="26px" height="26px" viewBox="-2 1 11 32" class="svg-icon c-arrow"><path data-v-12e91ab4="" d="M10.625 17.429c0 0.143-0.071 0.304-0.179 0.411l-8.321 8.321c-0.107 0.107-0.268 0.179-0.411 0.179s-0.304-0.071-0.411-0.179l-0.893-0.893c-0.107-0.107-0.179-0.25-0.179-0.411 0-0.143 0.071-0.304 0.179-0.411l7.018-7.018-7.018-7.018c-0.107-0.107-0.179-0.268-0.179-0.411s0.071-0.304 0.179-0.411l0.893-0.893c0.107-0.107 0.268-0.179 0.411-0.179s0.304 0.071 0.411 0.179l8.321 8.321c0.107 0.107 0.179 0.268 0.179 0.411z"></path></svg></a>
            </div>
            <div class="d-flex flex-nowrap align-items-center js-weekdays bg-light justify-content-between">
		...
		function events() {
			container
				...
				.on('click', '[data-date]', function (e) {
					...
					sessionStorage.setItem( 'date_set_click', date.showDateFormatted2() );
					
					// calendar ajax request js 
					e.preventDefault();
					var dateGet = date.showDateFormatted();
					var dayGet = date.showDayFormatted();
					$.ajax({
						type: 'POST',
						url: bookAjax.ajaxurl,
						data: {
							action: 'calenderRequest',
							'dayGet' : dayGet,
							'dateGet' : dateGet,
						},
						beforeSend: function() {
							$('.am-service-list').hide();
							$('.am-spinner').show();
						},
